...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
    ...
    if( pFrame == NULL ) 
		return 0;
    pFrame->Create(NULL, _T("OneOffice"), UI_WNDSTYLE_FRAME|WS_CLIPCHILDREN, WS_EX_WINDOWEDGE);
    pFrame->CenterWindow();
    pFrame->ShowWindow(true);
#endif

#if 1
	CDuiFrameWnd *OneOfficeFrame = new CDuiFrameWnd();
	OneOfficeFrame->Create(NULL, _T("OneOffice"), UI_WNDSTYLE_FRAME, WS_EX_WINDOWEDGE);
	OneOfficeFrame->CenterWindow();
	OneOfficeFrame->ShowWindow(true);
#endif
